...
_RANGES: Dict[str, Tuple[float, float]] = {
    ...
    "gestures.tap_speed_threshold": (0.0, 50.0),
    "gestures.tap_decel_ratio": (0.0, 1.0),
    "gestures.tap_time_ms": (1, 2000),
    "gestures.tap_cooldown_ms": (0, 5000),
    "gestures.swipe_decision_ms": (1, 2000),
    "gestures.swipe_distance_threshold": (0.0, 1.0),
    "gestures.scroll_speed_threshold": (0.0, 50.0),
